  ...
  return (
    <div className="max-w-sm mx-auto">
      ...
      <select
        ...
        className="bg-white border-2 border-solid border-orange-500 text-gray-700 text-sm rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 p-2.5"
      >
